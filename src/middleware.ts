...
const PUBLIC_API = ["/api/auth/login", "/api/auth/logout", "/api/auth/me", "/api/auth/register", "/api/auth/forgot-password", "/api/health"];
...
export const config = {
  matcher: ["/((?!_next/static|_next/image|manifest.webmanifest|sw\\.js|icons|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)"],
};